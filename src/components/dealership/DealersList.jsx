...
const DealersList = () => {
  ...
  return (
    ...
    >
      <div
        className="dealers-list auto-container mb-4 mt-5 fs-6 p-3"
      >
        <div
          className="text-box p-5 pt-4 rounded-3"
          style={{ maxWidth: "900px", margin: "0 auto", backgroundColor: "#F5F7FC" }}
          // style={{ backgroundColor: "#F5F7FC" }}
        >
          <h2 className="mb-4 text-muted">Dealers</h2>
          <div className="row">
